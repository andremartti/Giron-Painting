    ...
    <header className="fixed inset-x-0 top-0 z-50">
      <div
        className={`transition-[background-color,box-shadow,backdrop-filter] duration-300 ${
          solid
            ? 'bg-paper/95 shadow-[0_1px_0_rgb(28_27_25/0.08),0_10px_30px_-20px_rgb(28_27_25/0.35)] backdrop-blur-md'
        ...
        >
                ...
                return (
                  <li key={item.id}>
                    <a
                      ...
                      } ${solid ? 'text-ink hover:text-brick-700' : 'text-white/90 hover:text-white'}`}
                    >
                      {t.nav[item.labelKey]}
                    </a>
                  </li>
          ...
          <div className="flex shrink-0 items-center gap-3">
            ...
            <button
              ...
              className={`flex size-11 items-center justify-center rounded-md border transition-colors xl:hidden ${
